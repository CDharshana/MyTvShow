...
<div class="container">
    ...
    <div class="jumbotron">
        <h2 class="display-3">Ip Man Movie Series</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">Ip Man(2008)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 8.0</h2>
                </div>
                <a href="images/ip01.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/ip01.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">Ip Man 2(2010)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 7.6</h2>
                </div>
                <a href="images/ip02.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/ip02.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">Ip Man 3(2015)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 7.1</h2>
                </div>
                <a href="images/ip04.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/ip04.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
