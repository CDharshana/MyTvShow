...
<div class="container">
    ...
    <div class="jumbotron">
        <h2 class="display-3">The Chronicles of Narnia movie series</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">The Lion, the Witch and the Wardrobe(2005)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 6.9</h2>
                </div>
                <a href="images/nar02.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/nar02.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">Prince Caspian<br>(2008)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 6.5</h2>
                </div>
                <a href="images/nar01.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/nar01.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">The Voyage of the Dawn Treader(2010)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 6.3</h2>
                </div>
                <a href="images/nar05.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/nar05.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
