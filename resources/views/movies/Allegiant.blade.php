...
<div class="container">
    ...
    <div class="jumbotron">
        <h2 class="display-3">Divergent Movie Series</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">Divergent(2014)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 6.7</h2>
                </div>
                <a href="images/diver03.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/diver03.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">Insurgent(2015)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 6.2</h2>
                </div>
                <a href="images/diver02.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/diver02.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
        ...
        <div class="col-md-4">
            <div class="card mb-3">
                <h3 class="card-header">Allegiant(2016)</h3>
                <div class="card-body">
                    <h2 class="card-header text-primary"><i class="fab fa-imdb"></i> 5.7</h2>
                </div>
                <a href="images/diver04.jpg" data-lightbox="gallery" data-title="100"><img style="height: 200px; width: 100%; display: block;" src="images/diver04.jpg" alt="Card image"></a>
                <div class="card-body">
                    <p class="card-text">
